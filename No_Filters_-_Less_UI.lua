                    ...
                    {
                        {
                            ...
                            ["VALUE_CHANGE_TABLE"]  =   
                            {
                                ...
                                --default "TEXTURES/LUT/FILTERS/BINOCULARS.DDS"
                            }
                        },
                        {
                            ...
                            {
                                {"Filename", "TEXTURES/LUT/FILTERS/DEFAULT.DDS"},
                                --"TEXTURES/LUT/FILTERS/SURVEYING1.DDS"
                            }
                        },	
                        {
                            ["PRECEDING_KEY_WORDS"] = "FreighterAbandoned",
                            ["VALUE_CHANGE_TABLE"]  =   
                            {
                                {"Filename", "TEXTURES/LUT/FILTERS/DEFAULT.DDS"},
                                --Default "TEXTURES/LUT/FILTERS/AFDEFAULT.DDS"
                            }
                        },						
                    },
                },
